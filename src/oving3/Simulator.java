...
//			memory.processCompleted(p);
	...
	/**
	 * Generating new events. The goal is to have the CPU to sleep as little as possible.
	 * I am checking to see if the next upcoming IOOperation comes before the max time 
	 * that the CPU will run.
	 * It also checks to see if the cputime needed by the current process can be done before
